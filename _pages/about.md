...
Hi! I'm Jasmine Khalil, a first-year PhD student and IBM fellow in the **Medical Engineering Discovery MEDLab** at Vanderbilt University's [Vanderbilt Institute for Surgery and Engineering (VISE)](https://www.vumc.org/vise/). I earned my B.S. in Electrical Engineering from **Penn State University**, where I was a Schreyer Honors Scholar. My research interests lie at the intersection of **computer vision, robotics, machine learning, and healthcare**. I am particularly interested in developing intelligent and autonomous systems that can improve patient care and expand access to healthcare.
...
During my time at Penn State, I served as a **Teaching Assistant and Mentor for the Electrical Engineering First-Year Seminar**, where I helped teach and mentor first-year engineering students through hands-on microcontroller projects. I was also involved in engineering honor societies, including [**Eta Kappa Nu (HKN)**](https://sites.psu.edu/hkneecs/), and [**Tau Beta Pi**](https://sites.psu.edu/tbppab/).
